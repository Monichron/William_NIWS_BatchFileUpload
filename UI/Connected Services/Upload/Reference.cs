...
namespace UI.Upload {
    ...
    public partial class LimitResponse : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        private UI.Upload.Errors ErrorsField;
        
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private UI.Upload.Limits LimitsField;
        ...
        public UI.Upload.Errors Errors {
            get {
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public UI.Upload.Limits Limits {
            get {
    ...
    [System.SerializableAttribute()]
    [System.Runtime.Serialization.KnownTypeAttribute(typeof(UI.Upload.AddMandateResponse))]
    ...
    [System.SerializableAttribute()]
    public partial class AddMandateResponse : UI.Upload.NIWSResponseContainer {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="Upload.INIWS_NIF")]
    public interface INIWS_NIF {
        ...
        UI.Upload.LimitResponse GetPaymentLimits(string ServiceKey);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/INIWS_NIF/GetPaymentLimits", ReplyAction="http://tempuri.org/INIWS_NIF/GetPaymentLimitsResponse")]
        System.Threading.Tasks.Task<UI.Upload.LimitResponse> GetPaymentLimitsAsync(string ServiceKey);
        ...
        UI.Upload.LimitResponse GetDebitLimits(string ServiceKey);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/INIWS_NIF/GetDebitLimits", ReplyAction="http://tempuri.org/INIWS_NIF/GetDebitLimitsResponse")]
        System.Threading.Tasks.Task<UI.Upload.LimitResponse> GetDebitLimitsAsync(string ServiceKey);
        ...
        UI.Upload.MerchantStatementSourceStatusResponse MerchantStatementSourceStatus(string ServiceKey, string Date);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/INIWS_NIF/MerchantStatementSourceStatus", ReplyAction="http://tempuri.org/INIWS_NIF/MerchantStatementSourceStatusResponse")]
        System.Threading.Tasks.Task<UI.Upload.MerchantStatementSourceStatusResponse> MerchantStatementSourceStatusAsync(string ServiceKey, string Date);
        ...
        UI.Upload.AddMandateResponse AddMandate(
                    string ServiceKey, 
                    ...
                    string MobileNumber, 
                    UI.Upload.MandateOptionsMandateDebitFrequency DebitFrequency, 
                    ...
                    System.Nullable<UI.Upload.MandateOptionsMandatePublicHolidayOption> PublicHolidayOption, 
                    string Notes, 
                    string Field1, 
                    string Field2, 
                    string Field3, 
                    ...
                    string BranchCode, 
                    System.Nullable<UI.Upload.MandateOptionsBankAccountType> BankAccountType, 
                    ...
                    System.Nullable<UI.Upload.MandateOptionsTitle> Title, 
                    string EmailAddress, 
                    string PhoneNumber, 
                    string DateOfBirth, 
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/INIWS_NIF/AddMandate", ReplyAction="http://tempuri.org/INIWS_NIF/AddMandateResponse")]
        System.Threading.Tasks.Task<UI.Upload.AddMandateResponse> AddMandateAsync(
                    string ServiceKey, 
                    string AccountReference, 
                    string MandateName, 
                    decimal MandateAmount, 
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface INIWS_NIFChannel : UI.Upload.INIWS_NIF, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class NIWS_NIFClient : System.ServiceModel.ClientBase<UI.Upload.INIWS_NIF>, UI.Upload.INIWS_NIF {
        ...
        public UI.Upload.LimitResponse GetPaymentLimits(string ServiceKey) {
            return base.Channel.GetPaymentLimits(ServiceKey);
        }
        
        public System.Threading.Tasks.Task<UI.Upload.LimitResponse> GetPaymentLimitsAsync(string ServiceKey) {
            return base.Channel.GetPaymentLimitsAsync(ServiceKey);
        }
        
        public UI.Upload.LimitResponse GetDebitLimits(string ServiceKey) {
            return base.Channel.GetDebitLimits(ServiceKey);
        }
        
        public System.Threading.Tasks.Task<UI.Upload.LimitResponse> GetDebitLimitsAsync(string ServiceKey) {
        ...
        public UI.Upload.MerchantStatementSourceStatusResponse MerchantStatementSourceStatus(string ServiceKey, string Date) {
            return base.Channel.MerchantStatementSourceStatus(ServiceKey, Date);
        }
        
        public System.Threading.Tasks.Task<UI.Upload.MerchantStatementSourceStatusResponse> MerchantStatementSourceStatusAsync(string ServiceKey, string Date) {
        ...
        public UI.Upload.AddMandateResponse AddMandate(
                    string ServiceKey, 
                    string AccountReference, 
                    string MandateName, 
                    decimal MandateAmount, 
        ...
        public System.Threading.Tasks.Task<UI.Upload.AddMandateResponse> AddMandateAsync(
                    string ServiceKey, 
                    string AccountReference, 
                    string MandateName, 
                    decimal MandateAmount, 
